...
(function () {
  ...
  Unitest.addTestModule(function () {
    return Unitest.addTest('import contact test', async function () {
      var TEST_APP_TOKEN, chatleApi, privKey, res;
  ...
  Unitest.addTest('import notary with bytestring hash id of file', async function () {
    var APP_TOKEN, az1key, chatleApi, res;
  ...
  Unitest.addTest('import contract test', async function () {
    var TEST_APP_TOKEN, chatleApi, privKey, res;
    TEST_APP_TOKEN = "ehUEdnfhDqhBAWK77Rndam0d+L6NVhGDGm/ma3SHHZQA4kgs4uf1AnYJKqKHU2qQZchSeieZyquGOuCHeUtULw==";
    privKey = dec64('');
    chatleApi = await CryptoCloud.connect(TEST_APP_TOKEN, privKey);
  ...
  //console.log(wq)
  Unitest.addTest('import pair test', async function () {
    var TEST_APP_TOKEN, chatleApi, privKey, res;
    TEST_APP_TOKEN = "ehUEdnfhDqhBAWK77Rndam0d+L6NVhGDGm/ma3SHHZQA4kgs4uf1AnYJKqKHU2qQZchSeieZyquGOuCHeUtULw==";
    privKey = dec64('');
    chatleApi = await CryptoCloud.connect(TEST_APP_TOKEN, privKey);
